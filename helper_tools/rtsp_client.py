...
# if you don't have this from your linux distro, install with "pip install bitstring"
import bitstring
import re
'''
import socket
...
# just the channel infos
adr = "rtsp://192.168.1.99:554/?src=1&freq=12188&pol=h&ro=0.35&msys=dvbs&mtype=qpsk&plts=off&sr=27500&fec=34&pids=0,17,18"
# the client ports we are going to use for receiving video
...
setu = "SETUP "+adr+" RTSP/1.0\r\nCSeq: 0\r\nUser-Agent: python\r\nTransport: RTP/AVP;unicast;client_port=" + \
    str(clientports[0])+"-"+str(clientports[1])+"\r\n\r\n"
#play="PLAY rtsp://"+ip+":554/stream=1 RTSP/1.0\r\nCSeq: 1\r\nUser-Agent: python\r\nSession: SESID\r\nRange: npt=0.000-\r\n\r\n"
play = "PLAY rtsp://"+ip + \
    ":554/stream=1 RTSP/1.0\r\nCSeq: 1\r\nUser-Agent: python\r\nSession: SESID\r\n\r\n"
teardown = "TEARDOWN rtsp://"+ip + \
    ":554/stream=1 RTSP/1.0\r\nCSeq: 2\r\nUser-Agent: python\r\nSession: SESID\r\n\r\n"
...
print()
teardown = setsesid(teardown, idn)
